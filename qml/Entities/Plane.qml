...
//    collisionTestingOnlyMode: true
    ...
    force: Qt.point(twoAxisController.yAxis*forwardForce, twoAxisController.xAxis*forwardForce+100)//move speed
...
//          car.removeEntity()
  ...
  function handleInputAction(action) {
    if( action === "fire") {
      ...
      _manger.createEntityFromUrlWithProperties(Qt.resolvedUrl("Hero_bullet.qml"), {"x": imagePointInWorldCoordinates.x-46, "y": imagePointInWorldCoordinates.y-50, "rotation": car.rotation+270})
    }
  }
}
